...
import 'cross_cultural_stories_expansion.dart';
...
Map<Cuisine, Map<Course, Map<String, String>>> crossCulturalStories = {
  // ─────────────────────────────────────────────────────────────────────
  // Korean
  // ─────────────────────────────────────────────────────────────────────
  Cuisine.korean: {
    Course.breakfast: {
      ...
      'ko': "전통 한국식 아침은 밥과 뜨거운 국, 김치를 비롯한 다채로운 반찬이 일상적으로 올라 다른 상차림과 구분이 없습니다.",
    },
    Course.lunch: {
      'en':
      ...
      'ko': "점심에는 바쁜 일과 속에서 한 그릇 비빔밥이나 잔치국수 등으로 간편하고 든든하게 열량을 충원합니다.",
    },
    Course.appetizer: {
      'en':
    ...
    Course.sideDish: {
      ...
      'ko': "다채로운 밑반찬은 한국 식탁의 꽃이자 혼으로, 발효 영양을 담아 건강을 튼튼히 보살핍니다.",
    },
    Course.dessert: {
      'en':
      ...
      'ja': "伝統的な餅菓子（トック）から、ふわふわ和モダンのあずきかき氷（パッピンス）まで、魅惑の甘さです。",
      'ko': "디저트로는 쫄깃한 전통 인절미나 곱게 간 얼음 위에 단팥과 찰떡, 연유를 듬뿍 올린 시원한 빙수가 있습니다.",
    },
    Course.snack: {
      'en':
      ...
      'ja': "韓国の夜食を代表するのは「アンジュ」文化。サクサクのフライドチキンを冷たいビールで流し込みます。",
      'ko': "야식은 술과 즐기는 '안주' 요리가 으뜸이며 바삭한 치킨에 시원한 맥주를 곁들이는 치맥이 사랑받습니다.",
    },
    Course.drinks: {
      'en':
      ...
      'ko': "음료로는 구수한 전설 속 막걸리나 청량한 소주, 혹은 한국인들이 평소 생수처럼 마시는 구수한 보리차가 있습니다.",
    },
  },
  ...
  Cuisine.japanese: {
    Course.breakfast: {
      ...
      'ja': "一日の始まりは、炊きたてご飯、味噌汁、焼き魚、納豆が揃った伝統的な「朝ご飯」から健康的に。",
      'ko': "기본 정통 아침은 흰 고슬밥과 깔끔한 미소된장국, 연어소금구이와 영양 가득한 발효 낫토로 소박하게 채웁니다.",
    },
    Course.lunch: {
      'en':
      ...
      'ja': "日本の昼食は、彩り豊かなお弁当、職人手作りのラーメンやお蕎麦、そして愛おしいおにぎりが大活躍。",
      'ko': "점심에는 구색 맞춰 담아낸 예술적인 벤토(도시락)나 담백한 우동, 단골 야채 가미 삼각김밥 등이 주로 쓰입니다.",
    },
    Course.appetizer: {
      'en':
      ...
      'ja': "お食事前の一皿は、手軽な塩茹で枝豆、旬野菜のさっぱり天ぷら、ひんやり冷奴で胃腸を優しく整えます。",
      'ko': "전채 요리는 소금을 치며 끓여 낸 에다마메, 얇은 튀김옷의 수제 텐푸라, 촉촉한 냉두부가 감칠맛을 당깁니다.",
    },
    Course.sideDish: {
      'en':
      ...
      'ja': "副菜には、酸味が心地よい酢の物や、ダシのコクを煮含めたお母さん手作りの心の煮物が大人気。",
      'ko':
    ...
    Course.dessert: {
      ...
      'ja': "和菓子職人手作りの練り切り、三色だんご、あるいは抹茶もちアイスクリームが最高のご褒美。",
      'ko':
    ...
    Course.snack: {
      ...
      'ja': "深夜の胃袋を満たすのは、香ばしい焼き鳥、タコが入った熱々のたこ焼き、肌寒い夜に心に染みるおでんです。",
      'ko':
    ...
    Course.drinks: {
      ...
      'ja': "日本の飲料は、本格的なお抹茶、お猪口で酌み交わす日本酒、シュワっと清涼な喉越し極上のレモンハイボール。",
      'ko':
  ...
  Cuisine.chinese: {
    Course.breakfast: {
      ...
      'ko': "아시아 식탁의 아침은 따끈하게 달인 두유에 갓 튀긴 꽈배기 빵을 비벼 먹거나, 고기 왕만두와 만두국을 즐깁니다.",
    },
    Course.lunch: {
      'en':
      ...
      'ja': "お昼はお腹いっぱいに。パリッと強火炒めのチャーハン、叉焼丼、熱いスープヌードルが体温を上げます。",
      'ko': "점심에는 고슬고슬하게 불맛 나게 볶은 소고기 볶음면이나 양념 붉은 차슈를 얹은 소스 덮밥 한 그릇이 유행합니다.",
    },
    Course.appetizer: {
      'en':
      ...
      'ja': "お食事前には、さっぱりキュウリのラー油和え、蒸し器からあがる熱々の小籠包やえび餃子でおもてなし。",
      'ko':
    ...
    Course.sideDish: {
      ...
      'ja': "美味しいおかずは、強火でサッと炒めた青菜のにんにく炒め、山椒がビリリと痺れる四川の麻婆豆腐など調理技術の結晶。",
      'ko':
    ...
    Course.dessert: {
      ...
      'ja': "おしまいは、もちもちの中に黒ごま餡がとろりとあふれる団子（湯圓）やサクサクほくほくの焼き立てエッグタルト。",
      'ko':
    ...
    Course.snack: {
      ...
      'ja': "夜市で買いたいのは、鉄板で底をカリカリに焼き上げた生煎包、サクサク小麦生地の煎餅果子。",
      'ko':
    ...
    Course.drinks: {
      ...
      'ja': "伝統的なプーアル茶、華やか香るジャスミン茶、あるいは現代の若者に熱狂的に愛されるもちもちのタピオカミルクティー。",
      'ko':
  ...
  Cuisine.taiwanese: {
    Course.breakfast: {
      'en':
          "Taiwanese mornings favor soy milk with youtiao, scallion pancakes, or a bowl of warm rice porridge topped with pickles and shredded pork.",
      'zh': "台式早餐常是一杯热豆浆配油条、葱油饼，或是一碗撒着酱菜与肉丝的咸粥。",
      'ja': "台湾の朝は豆乳と油条、葱油餅、あるいはピクルスと豚肉のかや粥で始まります。",
      'ko': "대만식 아침은 따뜻한 두유와 유탸우, 파전, 또는 절임과 돼지고기를 얹은 죽으로 채웁니다.",
      'vi':
          "Bữa sáng Đài Loan thường là sữa đậu nành với quẩy, bánh hành hoặc cháo muối với dưa chua và thịt heo.",
    },
    Course.lunch: {
      'en':
          "Lunch runs on beef noodle soup, lu rou fan over rice, bento boxes, and quick stir-fried noodles from neighborhood gua bao stalls.",
      'zh': "午餐离不开牛肉面、卤肉饭、便当，或街角快炒面与割包小摊的一碗热食。",
      'ja': "昼は牛肉麺、魯肉飯、弁当、屋台の炒め麺や割包が定番です。",
      'ko': "점심은 우육면, 루러우판, 도시락, 길가 볶음면과 꽈바오가 대표적입니다.",
      'vi':
          "Bữa trưa gắn với mì bò, cơm thịt kho, hộp cơm và mì xào nhanh từ quán ven đường.",
    },
    Course.appetizer: {
      'en':
          "Starters include xiao long bao, pan-fried dumplings, oyster omelettes, and chilled wood-ear mushroom salads with black vinegar.",
      'zh': "前菜有小龙汤包、锅贴、蚵仔煎，或黑醋凉拌木耳等清爽小菜。",
      'ja': "前菜は小籠包、鍋貼、オイスターオムレツ、黒酢の木耳和えなど。",
      'ko': "전채로는 샤오롱바오, 군만두, 굴 오믈렛, 흑초 무침 목이버섯이 흔합니다.",
      'vi':
          "Khai vị có tiểu long bao, quẩy chiên, trứng chiên hàu và nấm mèo trộn giấm đen.",
    },
    Course.sideDish: {
      'en':
          "Sides lean on blanched greens with garlic, three-cup aromas, and quick pickles that balance rich mains.",
      'zh': "配菜多是蒜蓉烫青菜、三杯风味小炒，或解腻的泡菜与酱瓜。",
      'ja': "副菜はニンニク青菜、三杯鶏のような香り付け、漬物で主菜を引き立てます。",
      'ko': "반찬은 마늘 채소, 삼컵 향 조림, 그리고 짠 메인을 받쳐 주는 장아찌입니다.",
      'vi':
          "Món phụ thường là rau luộc tỏi, hương tam bôi và dưa chua cân bằng món chính.",
    },
    Course.dessert: {
      'en':
          "Sweets span pineapple cake, mochi, shaved ice with red beans, and silky tofu pudding with ginger syrup.",
      'zh': "甜点从凤梨酥、麻糬、红豆刨冰，到姜汁豆花，甜而不腻。",
      'ja': "甘味はパイナップルケーキ、餅、小豆かき氷、生姜シロップの豆花など。",
      'ko': "디저트는 파인애플 케이크, 떡, 팥 빙수, 생강 시럽 두부 푸딩이 대표적입니다.",
      'vi': "Tráng miệng gồm bánh dứa, mochi, bào bing đậu đỏ và đậu hũ gừng.",
    },
    Course.snack: {
      'en':
          "Night markets thrive on stinky tofu, grilled squid, popcorn chicken, and bubble tea on every corner.",
      'zh': "夜市离不开臭豆腐、烤鱿鱼、盐酥鸡，以及转角处的珍珠奶茶。",
      'ja': "夜市は臭豆腐、イカ焼き、塩酥鶏、タピオカミルクティーが主役です。",
      'ko': "야시장은 취두부, 오징어 구이, 팝콘 치킨, 버블티로 밤을 채웁니다.",
      'vi':
          "Chợ đêm nổi tiếng với đậu phụ thối, mực nướng, gà muối và trà sữa trân châu.",
    },
    Course.drinks: {
      'en':
          "Drinks mean pearl milk tea, high-mountain oolong, sour plum juice, and sweet grass-jelly teas for humid afternoons.",
      'zh': "饮品从珍珠奶茶、高山乌龙、酸梅汤，到消暑的仙草茶。",
      'ja': "飲み物はタピオカミルクティー、高山烏龍茶、酸梅湯、仙草茶が定番です。",
      'ko': "음료는 버블티, 고산 우롱차, 매실 음료, 여름철 선초차가 인기입니다.",
      'vi':
          "Đồ uống gồm trà sữa trân châu, oolong cao nguyên, mơ chua và trà thạch cao.",
    },
  },
  ...
  Cuisine.mongolian: {
    Course.breakfast: {
      'en':
          "Breakfast is hearty: suutei tsai milk tea with boortsog fried dough, aaruul dried curd, or leftover buuz from the night before.",
      'zh': "蒙古早餐扎实——奶茶配油炸面点包尔扫格、奶干，或前一晚剩下的包子。",
      'ja': "朝食はボーツォグの揚げ菓子やアールール乳製品、ブースとスーテイチャイの奶茶で満ちます。",
      'ko': "아침은 보르초그, 아루울 치즈, 부즈와 소금 차 수테이 차이로 든든하게 시작합니다.",
      'vi':
          "Bữa sáng Mông Cổ gồm trà sữa suutei tsai với bánh rán boortsog, phô mai khô aaruul hoặc buuz còn lại.",
    },
    Course.lunch: {
      'en':
          "Lunch centers on tsuivan hand-pulled noodles with mutton, khorkhog stone-pot meat, or rice with quick stir-fried vegetables.",
      'zh': "午餐常吃手拉面炒肉策瓦因、石头烤肉霍爾霍格，或配菜快炒的米饭。",
      'ja': "昼はツイヴァンの手打ち麺炒め、ホルホグの石焼肉、野菜炒めご飯が中心です。",
      'ko': "점심은 츠이반 손짜장면, 호르호그 돌구이 고기, 볶음 채소 밥이 중심입니다.",
      'vi':
          "Bữa trưa quanh mì tsuivan, thịt khorkhog nướng đá hoặc cơm với rau xào.",
    },
    Course.appetizer: {
      'en':
          "Starters feature buuz steamed dumplings, bansh smaller dumplings, and shared plates of dried curds with tea.",
      'zh': "开胃有蒸包子布兹、小包子班什，以及配奶茶分享的奶干拼盘。",
      'ja': "前菜はブーズの蒸し餃子、バンシ、奶茶と一緒に出る乳製品の盛り合わせです。",
      'ko': "전채는 찐 만두 부즈, 반시, 차와 곁들이는 건락 치즈가 대표적입니다.",
      'vi': "Khai vị có buuz hấp, bansh và đĩa sữa khô ăn kèm trà.",
    },
    Course.sideDish: {
      'en':
          "Sides are simple: pickled vegetables, boiled root vegetables, and salads dressed with sheep-tail fat for cold steppe nights.",
      'zh': "配菜朴素——泡菜、煮根茎蔬菜，或羊尾油拌沙拉御寒。",
      'ja': "副菜は漬物、根菜の茹で物、羊の尾脂で和えたサラダなどシンプルです。",
      'ko': "반찬은 절임, 삶은 뿌리채소, 양꼬리 기름 드레싱 샐러드가 흔합니다.",
      'vi': "Món phụ đơn giản: dưa muối, củ luộc và salad mỡ đuôi cừu.",
    },
    Course.dessert: {
      'en':
          "Sweets mean boortsog fried pastries, aaruul with sugar, and milk tea reduced into caramel-like treats for guests.",
      'zh': "甜点有油炸包尔扫格、加糖奶干，以及熬浓请客的奶茶甜膏。",
      'ja': "甘味はボーツォグ、砂糖のアールール、濃い奶茶の甘いおやつです。",
      'ko': "디저트는 보르초그, 설탕 아루울, 진한 우유차 과자가 흔합니다.",
      'vi': "Tráng miệng gồm boortsog, aaruul ngọt và kẹo từ trà sữa cô đặc.",
    },
    Course.snack: {
      'en':
          "Snacks shine at Naadam: crisp khuushuur fried pastries, grilled skewers, and airag fermented mare's milk shared in bowls.",
      'zh': "那达慕小吃最出名——酥脆炸包子胡舒尔、烤肉串，以及碗装发酵马奶酒。",
      'ja': "ナーダムの軽食はカーフーフルの揚げ餃子、串焼き、馬奶酒アイラグが象徴的です。",
      'ko': "간식은 나담의 후슈르 튀김만두, 꼬치구이, 발효 마유 아이라그가 빛납니다.",
      'vi':
          "Ăn vặt nổi bật ở Naadam: khuushuur chiên giòn, xiên nướng và airag sữa ngựa lên men.",
    },
    Course.drinks: {
      'en':
          "Drinks revolve around suutei tsai salted milk tea, airag, and vodka toasts that open every shared meal on the steppe.",
      'zh': "饮品以咸奶茶、马奶酒和草原宴会上必备的伏特加祝酒为主。",
      'ja': "飲み物は咸奶茶スーテイチャイ、馬奶酒アイラグ、草原の乾杯用ウォッカが中心です。",
      'ko': "음료는 소금 차 수테이 차이, 아이라그, 초원 잔치의 보드카 건배가 중심입니다.",
      'vi':
          "Đồ uống xoay quanh trà sữa mặn, airag và vodka mở đầu mỗi bữa trên thảo nguyên.",
    },
  },
  ...
  Cuisine.thai: {
    Course.breakfast: {
      ...
      'ja': "一日のスタートは、柔らかく炊いた温粥ジョーク、または甘辛だれをまとった豚串ムーピンをもち米と一緒に。",
      'ko':
    ...
    Course.lunch: {
      ...
      'ja': "ランチは人気米粉麺焼きパッタイ、ハーブ満載辛酸っぱいトムヤムラーメン、ホーリーバジルのガパオライス！",
      'ko':
    ...
    Course.appetizer: {
      ...
      'ja': "さくさくの春巻き、ハーブ香るトードマンプラー、甘口ピーナッツソースに浸す芳醇な鶏ささみサテで笑顔に。",
      'ko':
    ...
    Course.sideDish: {
      ...
      'ja': "食卓の中心には、ライムとにんにく、唐辛子ですりこぎで青パパイヤを叩き和える究極ヘルシーサラダソムタム。",
      'ko':
    ...
    Course.dessert: {
      ...
      'ja': "甘いもち米に濃厚ココナッツソースを絡め、ジューシーな完熟マンゴーを贅沢に伴わせた究極デザートマムアンもち米。",
      'ko':
    ...
    Course.snack: {
      ...
      'ja': "屋台でおばちゃんが手際よく焼く、練乳てんこもりの甘口クレープ「ロティ」や、ココナッツ衣をまとった熱々揚げバナナが王道。",
      'ko':
    ...
    Course.drinks: {
      ...
      'ja': "深く強いお茶のボディに練乳をあふれるほど足してキンキンに冷やした、夕日色ミルクティーチャーイェン。",
      'ko':
  ...
  Cuisine.indian: {
    Course.breakfast: {
      ...
      'zh':
          "印度早餐充满地域特色——南部是塞满香料土豆泥的松脆多萨大饼（Dosa）佐椰子酱；北部则是油香的土豆馅饼（Paratha）配冰凉酸奶。",
    ...
    Course.lunch: {
      ...
      'ja': "大きめの金属皿ターリーの真ん中で、数種類のコク旨カレー、焼き立て薄焼きチャパティやナンをちぎりながら大満足ランチ。",
      'ko':
    ...
    Course.appetizer: {
      ...
      'ja': "熱烈なおもてなしはスパイシー三角餃子サモサ。にんにくとクミン、ターメリックで練ったポテト餡がぎっしり。",
      'ko': "가장 대중적인 세모난 만두 '사모사'에는 카레 향 감자와 완두콩 소가 가득 차 있어 기분을 올립니다.",
    },
    Course.sideDish: {
      'en':
      ...
      'ko': "매콤함을 달래 주는 오이 요거트 샐러드 '라이타', 레몬과 마살라 가루를 뿌린 매운 적양파가 상에 오릅니다.",
    },
    Course.dessert: {
      'en':
    ...
    Course.snack: {
      ...
      'ko': "동그랗게 튀겨 구멍을 낸 푸리 볼 안에 매콤새콤한 수프 액상과 감자를 짜 넣어 맛봅니다.",
    },
    Course.drinks: {
      'en':
      ...
      'ko': "인도의 대표 주스는 수제 요거트 스무디 형태의 보드라운 '망고라씨'입니다. 따뜻한 '마살라 차이'도 유행합니다.",
    },
  },
  ...
  Cuisine.italian: {
    Course.breakfast: {
      ...
      'ja': "朝の始まりは最寄りのバールで。立ち飲みですする濃密熱々エスプレッソに、カスタード角パンコルネット。",
      'ko': "이탈리아의 아침은 골목 카페 바에서 시작됩니다. 에스프레소 한 잔에 빵 '코르네토'를 곁들입니다.",
    },
    Course.lunch: {
      'en':
      ...
      'ja': "茹でたてのコシを大切に。上質オリーブオイルと潰しにんにくを乳化させたシンプルな絶品オイルスパゲティ。",
      'ko':
    ...
    Course.appetizer: {
      ...
      'ja': "とろける水牛乳の白いチーズ、生ハムを贅沢に。そして香ばしく焼いたバゲットに完熟スライストマトを山盛りのブルスケッタ。",
      'ko':
    ...
    Course.sideDish: {
      ...
      'ko': "이탈리아의 야채 요리는 오븐에 구워 발사믹 식초를 뿌린 주키니 호박과 알감자가 대표적입니다.",
    },
    Course.dessert: {
      'en':
    ...
    Course.snack: {
      ...
      'ja': "お腹の隙間を塞ぐのは、中からとろりとモッツァレラが溶け出す至福のシチリア風揚げサフランご飯ボールアランチーニ。",
      'ko':
    ...
    Course.drinks: {
      ...
      'ja': "アペリティーボで始まる夕暮れ。目にも鮮やかな赤いアペロール・スプリッツに、甘酸っぱく冷えたレモンリキュールリモンチェッロ。",
      'ko': "초저녁 분위기는 주황빛 오렌지 껍질 베이스의 '아페롤 스프릿츠'와 식후 소화를 돕는 '레몬첼로'가 있습니다.",
    },
  },
  ...
  Cuisine.americanWestern: {
    Course.breakfast: {
      ...
      'ko': "미국식 아침은 버터밀크 팬케이크를 구워 달콤한 메이플 시럽을 흘러넘치게 뿌리고 커피 한 잔으로 시작합니다.",
    },
    Course.lunch: {
      'en':
      ...
      'ko': "점심에는 육즙 가득 스매시 패티 치즈버거류, 얇게 저민 소고기와 스위스 치즈를 얹은 샌드위치가 널리 쓰입니다.",
    },
    Course.appetizer: {
      'en':
      ...
      'ja': "バーやスポーツ観戦で。赤いスパイシーソースをまとった手羽先バッファローウィングをブルーチーズソースに。",
      'ko':
    ...
    Course.sideDish: {
      ...
      'ja': "メインを脅かす濃厚マカロニチーズ、一息つかせてくれる酸味甘みの冷たいコールスロー、バター焼きトウモロコシ。",
      'ko':
    ...
    Course.drinks: {
      ...
      'ja': "喉を潤す極上レモネード。アメリカンの青春が詰まったハーブ風黒い独特炭酸ドリンクルートビアフロート。",
      'ko':
  ...
  Cuisine.mexican: {
    ...
    Course.lunch: {
      ...
      'ja': "お昼はお肉屋台のタコス。牛肉やチキンを刻みパセリとライムで引き締めて。重厚なブリトーも人気満点。",
      'ko':
    ...
    Course.appetizer: {
      ...
      'ja': "出来立てでサクサク軽い金スナックに、大粒のアボカド、塩、ライムをマッシュしたワカモレをたっぷりと。",
      'ko':
  ...
  Cuisine.french: {
    Course.breakfast: {
      ...
      'ja': "熱々のサクサクのクロワッサンに、バターをたっぷり吸わせたバゲットを、大きなカフェボウルにひたして味わう贅沢。",
      'ko':
    ...
    Course.lunch: {
      ...
      'ja': "ハムと極厚チーズを挟み、極上ホワイトベシャメルをたっぷりかけてオーブンで焼いた大定番のクロックムッシュ。",
      'ko':
    ...
    Course.appetizer: {
      ...
      'ja': "時間をかけて飴色にソテーした玉ねぎスープをクルトンとチーズで蓋して焼いたオニオンスープやエスカルゴ。",
      'ko':
    ...
    Course.sideDish: {
      ...
      'ja': "色鮮やか季節夏野菜をトマトと香草オイルで蒸し煮にしたラタトゥイユ。ポテトグラタンも脇役の一流。",
      'ko': "프랑스의 대표 반찬은 야채찜 '라타투이'입니다. 주키니 호박과 가지를 얇게 슬랍하여 오븐에 촉촉이 익혀냅니다.",
    },
    Course.dessert: {
      'en':
...
String? storyFor(Cuisine cuisine, Course course, String langCode) {
  final display = cuisineForDisplay(cuisine);
  final byCourse = crossCulturalStories[display];
...
/// Sub-national wires (e.g. Shan → Burmese) resolve via [cuisineForDisplay].
bool hasStoriesFor(Cuisine cuisine) =>
    crossCulturalStories[cuisineForDisplay(cuisine)]?.isNotEmpty ?? false;
