...
class SpiceRouteApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      // Force a full subtree rebuild on locale flip so web routes /
      // modals that cached the prior [AppL10n] + translated recipe
      // copy don't keep rendering stale strings until a manual refresh.
