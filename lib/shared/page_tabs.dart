...
class PageTabs extends ConsumerWidget {
  ...
  static const _rightPaths = {'/saved', '/my-recipes'};
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final dests = AppShell.destinationsOf(l, signedIn: user != null);
    ...
    //   - Right group (Saved / Mine) always docks to the right edge.
